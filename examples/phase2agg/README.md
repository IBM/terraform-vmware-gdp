# Create GDP Aggregator for VMware

## Introduction

Use this example to create a GDP Aggregator on VMware.
...
Here you will enter all the parameters for your specific vSphere installations, as well as parameters for the Aggregator you are going to build.

Note that you must enter the IP address of the Central Manager you created earlier if you want this Aggregator to be registered to it.
