...
This module creates a GDP Aggregator on VMware.

## Parameters

All parameters must be modified in the terraform.tfvars and instances.json files. See the [documentation](../../examples/phase2agg/README.md) in the example for instructions.
...
| guardium_central_manager_ip | IP address of the CM |
