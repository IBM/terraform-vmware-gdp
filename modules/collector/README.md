...
This module creates a GDP Collector on VMware.

## Parameters

All parameters must be modified in the terraform.tfvars and instances.json files. See the [documentation](../../examples/phase3col/README.md) in the example for instructions.
